...
\begin{center}
\leavevmode
\includegraphics[height=2.000000cm]{interfaceIsisDb}
\end{center}
\end{figure}
...
\subsubsection[{\_\-\_\-construct}]{\setlength{\rightskip}{0pt plus 5cm}IsisDb::\_\-\_\-construct (
...
\subsubsection[{check}]{\setlength{\rightskip}{0pt plus 5cm}static IsisDb::check (
\begin{DoxyParamCaption}
\item[{\$}]{ schema, }
...
\subsubsection[{read}]{\setlength{\rightskip}{0pt plus 5cm}IsisDb::read (
\begin{DoxyParamCaption}
\item[{\$}]{ id}
\end{DoxyParamCaption}
)}}
